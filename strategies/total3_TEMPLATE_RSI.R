...
lgStFtrsi <-	function(clStore,column,iter) {
  ...
  #rsiL <- last(RSI(clStore[1:iter,column],n=params$lookbackL))
  

  #rsiSlag<-RSI(clStore[1:iter,column],n=params$lookbackS)[iter-1]
  #rsiLlag<-RSI(clStore[1:iter,column],n=params$lookbackL)[iter-1]
  #print(RSI(clStore[1:iter,column],n=params$lookbackS))
  #print(rsiS)
  ...
  #print(longs)
  #print(shorts)
  #print((rsiS > (50 + params$threshold))&&(shorts=-1))
  
  #print(shorts==-1)
  #print((rsiS > (50 + params$threshold)))
  #print((rsiS > (50 + params$threshold))&&(shorts=-1))
